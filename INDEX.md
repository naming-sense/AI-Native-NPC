...
| Goal Registry | v1 | [열기](contracts/current/goal_registry_v1.yaml) |
| Test Taxonomy | v1 | [열기](contracts/current/test_taxonomy_v1.yaml) |

## 관리·증거

- [Source File Map](reports/SOURCE_FILE_MAP.md)
- [Validation Report](reports/validation_report.md)
- [Freeze Manifest](manifest/freeze_manifest.json)
- [Catalog](manifest/catalog.json)
- [변경 관리](governance/CHANGE_CONTROL.md)
- [릴리스 체크리스트](governance/RELEASE_CHECKLIST.md)
