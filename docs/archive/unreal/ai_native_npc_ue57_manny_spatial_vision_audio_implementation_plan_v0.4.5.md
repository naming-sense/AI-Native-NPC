...
- 문서 버전: **v0.4.5**
- 문서 상태: **UE 5.7 Client Implementation Profile / Schema 2.0 RC4 Semantic Closure**
- 개정일: 2026-07-26
- 대체 문서: 기존 `ai_native_npc_ue57_manny_spatial_vision_audio_implementation_plan.md` v0.3
- 상위 기준서: `ai_native_npc_requirements_implementation_plan_v0.4.5.md`
- Tensor 단일 원본: `ai_native_npc_schema_v2_0.yaml`
- 상위 기준서 SHA-256: `9845a55fca4e42642b2aea1ddfb48389fe09c679e62489615400cef9deda83fa`
- Schema YAML SHA-256: `47c077fb6741860d799a3c275383442037dc562912f43ece2e91e45fc0cb86fb`
- Skill Registry SHA-256: `7bc1ab9b709754ddfcfc79f0211bb57e58aa616be522d86ff5666809c0494acb`
- Goal Registry SHA-256: `1f7d91ca0b3c7241a9b92cbf4e812e37f70f67b05bfc653ecbee39b137e8c749`
- Test Taxonomy SHA-256: `c93d864195c198b72f1bdfca70ef8c050a4b955526f2fb6d87a08694ec411a9a`
- Phase 0 판정: **GO**
...
> Tensor·Enum·Padding·Normalization·Hash가 충돌하면 본문보다 `ai_native_npc_schema_v2_0.yaml`이 우선하고, Goal·Target·Commit 책임이 충돌하면 상위 v0.4.5 요구사항이 우선한다.

---

# 0. v0.4.5 Semantic Closure 반영

최신 리뷰는 타당하다. UE 구현판은 YAML에서 생성된 Appendix·Normalizer·Hash serializer를 직접 소비하며, 문서 표와 런타임 바인딩이 서로 다른 계약을 선택하지 못하도록 변경한다.

RC4에서는 Hash magic 문장·JSON·백틱 수기 복제를 모두 거부하고, Critical Suite 최소 분모를 Taxonomy에서 자동 생성한다.
...
/AINativeNPC
  ...
  /Docs
    ai_native_npc_requirements_implementation_plan_v0.4.5.md
...
2. 상위 v0.4.5 요구사항: Goal, Target, Candidate, Commit, KPI
...
```bash
python tools/doc_harness.py release --output dist/ai_native_npc_document_harness_v0.4.5.zip
```
...
- Generator: `0.4.5`
- Contract revision: `2.0.0-rc4`
- Schema SHA-256: `47c077fb6741860d799a3c275383442037dc562912f43ece2e91e45fc0cb86fb`
- Skill Registry SHA-256: `7bc1ab9b709754ddfcfc79f0211bb57e58aa616be522d86ff5666809c0494acb`
- Goal Registry SHA-256: `1f7d91ca0b3c7241a9b92cbf4e812e37f70f67b05bfc653ecbee39b137e8c749`
- Test Taxonomy SHA-256: `c93d864195c198b72f1bdfca70ef8c050a4b955526f2fb6d87a08694ec411a9a`
...
| `count_max` | `8.0` |
| `schema_contract_revision` | `2.0.0-rc4` |
