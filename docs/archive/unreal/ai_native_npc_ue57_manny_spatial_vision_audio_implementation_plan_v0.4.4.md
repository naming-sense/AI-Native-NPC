...
- 문서 버전: **v0.4.4**
- 문서 상태: **UE 5.7 Client Implementation Profile / Schema 2.0 RC3 Semantic Closure**
- 개정일: 2026-07-26
- 대체 문서: 기존 `ai_native_npc_ue57_manny_spatial_vision_audio_implementation_plan.md` v0.3
- 상위 기준서: `ai_native_npc_requirements_implementation_plan_v0.4.4.md`
- Tensor 단일 원본: `ai_native_npc_schema_v2_0.yaml`
- 상위 기준서 SHA-256: `2f54b1a7654e992da9b856faddc11dbbb7d4eb0fd3dd1d220a3ff248557b2d9a`
- Schema YAML SHA-256: `a122a02df2c5ce9e3f7403667106e9d14bc287b9a5cf8e23e56281ee54222302`
...
> Tensor·Enum·Padding·Normalization·Hash가 충돌하면 본문보다 `ai_native_npc_schema_v2_0.yaml`이 우선하고, Goal·Target·Commit 책임이 충돌하면 상위 v0.4.4 요구사항이 우선한다.

---

# 0. v0.4.4 Semantic Closure 반영
...
/AINativeNPC
  ...
  /Docs
    ai_native_npc_requirements_implementation_plan_v0.4.4.md
...
2. 상위 v0.4.4 요구사항: Goal, Target, Candidate, Commit, KPI
...
```bash
python tools/doc_harness.py release --output dist/ai_native_npc_document_harness_v0.4.4.zip
```
