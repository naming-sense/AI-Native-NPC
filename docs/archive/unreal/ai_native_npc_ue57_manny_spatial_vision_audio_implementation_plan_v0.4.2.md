...
- 문서 버전: **v0.4.2**
- 문서 상태: **UE 5.7 Client Implementation Profile / Schema 2.0 RC1**
- 개정일: 2026-07-26
- 대체 문서: 기존 `ai_native_npc_ue57_manny_spatial_vision_audio_implementation_plan.md` v0.3
- 상위 기준서: `ai_native_npc_requirements_implementation_plan_v0.4.2.md`
- Tensor 단일 원본: `ai_native_npc_schema_v2_0.yaml`
- 상위 기준서 SHA-256: `23d75682b2305a27159b59ad587accfdc130ec134bfc2257d98ae75421920f20`
- Schema YAML SHA-256: `c4d0787b00bf68e165221dd44dd04d566ce8a9a3b403f2ca2bf2d924f4199c09`
- Skill Registry SHA-256: `0d79eed010fe91ebc297697c495a54c9ffc6a07e5422616683c0daf9baecf551`
- Goal Registry SHA-256: `f75231152b3931a5e24bf0dec14b0fdb9c38e2a059fd5f36bbc171f702996d56`
- Phase 0 판정: **GO**
...
> Tensor·Enum·Padding·Normalization·Hash가 충돌하면 본문보다 `ai_native_npc_schema_v2_0.yaml`이 우선하고, Goal·Target·Commit 책임이 충돌하면 상위 v0.4.2 요구사항이 우선한다.

---

# 0. v0.4.2 Cross-Environment Harness Hardening 반영

최신 리뷰는 타당하다. UE 구현판은 문서 설명만이 아니라 생성 코드와 실행형 계약을 직접 소비하도록 변경한다.
...
/AINativeNPC
  ...
  /Docs
    ai_native_npc_requirements_implementation_plan_v0.4.2.md
...
2. 상위 v0.4.2 요구사항: Goal, Target, Candidate, Commit, KPI
...
```bash
python tools/doc_harness.py release --output dist/ai_native_npc_document_harness_v0.4.2.zip
```
...
- float 제외
- Target Handle 17개
- Target Mask 17 bit, LSB-first, 3 byte
